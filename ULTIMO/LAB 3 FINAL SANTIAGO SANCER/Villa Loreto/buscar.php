...
<body>
    ...
    <form action=" buscar.php " method=" get" class="form_search">
                        ...
                        <input type="submit" value="buscar" class="btn_search" value="<?php echo $busqueda ?>">;
                        </form>
                            ...
                            <div class="container">
                                ...
                                <div id="main-container">
                                    <table class="table">
                                        ...
                                        <?php
                                        $sql = "SELECT COUNT(*) as total_registro  from proyectos
                                             WHERE
                                             (
                                                 nombre LIKE '%$busqueda%' OR
                                                 cantidad_personas LIKE '%$busqueda%' OR
                                                 m2 LIKE '%$busqueda%'
                                                  OR precio LIKE '%$busqueda%'
                                             )
                                
                                                 ";
                                        $sql_registe = mysqli_query($con, $sql);


                                        $result_register = mysqli_fetch_array($sql_registe); //consulta guardada en array
                                        ...
                                        $ejecutarQuery = mysqli_query($con, $sql);
                        ...
                        <section>
                            <div class="container">
                                <h1 class="">Consultas de Usuario</h1>
